...
namespace Orchestration.API.Models
{
    ...
    public class ExtractionRequest
    {
        ...
        public string? GetIdentifier() => !string.IsNullOrWhiteSpace(TeamcenterItemId) ? TeamcenterItemId
            : !string.IsNullOrWhiteSpace(MaterialId) ? MaterialId
            : !string.IsNullOrWhiteSpace(WorkItemId) ? WorkItemId : null;
    }
}
