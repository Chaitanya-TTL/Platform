...
export type IntelligenceDomainId="physical-attributes"|"product-context"|"requirements"|"changes"|"structure"|"configuration"|"operations"|"cost-inventory"|"evidence"|"cross-source";
