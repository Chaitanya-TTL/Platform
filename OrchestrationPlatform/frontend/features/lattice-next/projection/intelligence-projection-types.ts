...
export type IntelligenceDomainId="physical-attributes"|"product-context"|"requirements"|"changes"|"stock"|"accounting"|"history"|"structure"|"configuration"|"rules"|"localization"|"source-evidence"|"evidence"|"cross-source";
