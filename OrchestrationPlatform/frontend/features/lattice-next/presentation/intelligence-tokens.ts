export const SOURCE_TOKENS={teamcenter:{accent:"cyan",label:"Teamcenter"},windchill:{accent:"violet",label:"Windchill"},sap:{accent:"emerald",label:"SAP"},configit:{accent:"orange",label:"Configit"},unified:{accent:"slate",label:"Unified"},platform:{accent:"slate",label:"Platform"}} as const;
